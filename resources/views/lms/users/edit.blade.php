...
@section('page-title', isset($user)? $user->username : __('lang.fields.user.singular'))
...
@section('breadcrumbs')
    <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-11">
                <h2 class="content-header-title float-start mb-0">{{isset($user)? $user->profile ? $user->profile->full_name : __('lang.commons.add') : ''}}</h2>
