...
@section('breadcrumbs')
    <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h2 class="content-header-title float-start mb-0">{{__('lang.commons.create')}} {{__('lang.fields.category.singular')}}</h2>
    ...
    <div class="card">
        <form class="form form-vertical" action="{{ route('category.store')}}"
            ...
            <div class="card-body">
                ...
                @include('lms.categories.form-fields', ['categories' => $categories])
